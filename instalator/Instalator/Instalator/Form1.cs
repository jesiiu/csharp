...
namespace Instalator
{
    public partial class Form1 : Form
    {
        ...
        public void system_infos()
        {
            ...
            //If sprawdzaj¹cy czy checkbox danego programu jest zaznaczony, je¿eli jest wykonuje funkcje w nim zawart¹
            if(cpuz.Checked == true)
            {
                //Otworzenie nowego procesu
                Process myProcess = new Process();

                try
                {
                    //Próba utworzenia procesu i przejscia pod podany link url
                    //Je¿eli siê powiedzie to rozpocznie siê pobieranie pliku
                ...
                {
                    //Je¿eli nie uda siê przejœæ pod URL wyskoczy okienko z b³êdem
