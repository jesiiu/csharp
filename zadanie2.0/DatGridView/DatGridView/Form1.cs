...
namespace DatGridView
{
    public partial class Form1 : Form
    {
        ...
        private void button_add_Values(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Puste pola! Wprowadź dane");
            }
            else
            {
                int min = 0;
                ...
                //Sprawdzenie czy wprowadzana wartość mieści się w zakresie 
        ...
        //Pobieranie wartości z tabeli do edycji
        ...
        //Edytowanie wybranych wartości
        private void button_editValues(object sender, EventArgs e)
        {

            //Sprawdzenie czy zostały pobrane wartości do edytowania
            if (textBox1.Text == String.Empty || textBox2.Text == String.Empty || textBox3.Text == String.Empty || textBox4.Text == String.Empty)
            {
            ...
            else
            {
                ...
                //Sprawdzenie czy wprowadzone wartości do edycji mieszczą się w zakresie
